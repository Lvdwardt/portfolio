  ...
  return (
    <div className="relative row-span-2 overflow-hidden rounded-3xl bg-white p-6 font-bold dark:bg-[#2F3763] dark:text-white sm:order-2 xl:order-6 ">
      ...
      <div className="flex w-full rounded-full bg-pink-50  dark:bg-[#1F295B]">
        <div className=" animate-fadeIn48 bg-pinklight  h-6 w-[99%] rounded-full transition-all duration-300 ease-in dark:bg-[#8D5BE9]"></div>
      </div>
      <div className="mb-2 mt-5 flex justify-between">
        <h2>HTML &amp; CSS</h2>
        <h2>90%</h2>
      ...
      <div className="flex w-full rounded-full bg-pink-50 dark:bg-[#1F295B]">
        <div className=" animate-fadeIn46 bg-pinklight h-6 w-[90%] rounded-full transition-all duration-300 ease-in dark:bg-[#8D5BE9]"></div>
      </div>
