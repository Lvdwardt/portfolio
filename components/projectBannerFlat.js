...
export default function projectBannerFlat() {
  return (
    <div className="bg-pinklight group relative hidden overflow-hidden rounded-3xl dark:bg-[#2F3763] sm:order-4 sm:col-span-2 sm:block xl:order-10">
