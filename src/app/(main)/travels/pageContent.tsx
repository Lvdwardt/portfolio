...
export default function PageContent({
  ...
  return (
    <AnimatedLayout>
      <main className="relative flex animate-moveUp flex-col items-center justify-center rounded-xl p-4 pt-2 transition-all duration-300 ease-in xl:col-span-2 xl:row-span-2">
