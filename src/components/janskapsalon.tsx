...
export default function Janskapsalon() {
  return (
    <div className=" group relative overflow-hidden rounded-[2rem] bg-br sm:order-7 sm:row-span-2 xl:order-3 xl:col-start-4 xl:row-start-1">
      ...
      <div className=" absolute bottom-4 left-4 flex h-8 w-8 items-center justify-end gap-2 rounded-full bg-card p-2 text-text transition-all duration-300 ease-in group-hover:w-40">
