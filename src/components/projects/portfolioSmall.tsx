...
export default function PortfolioSmall() {
  return (
    <div className="group relative h-full w-full overflow-hidden rounded-[2rem]">
      ...
      <div className="absolute bottom-2 left-4 m-2 box-border flex h-12 w-8 items-center justify-center transition-all duration-700 group-hover:w-[120px] ">
        <div className="rounded-full border-transparent transition-all duration-300 hover:border-4 hover:border-trans">
          <Link
            ...
            className="flex h-8 w-8 items-center justify-end gap-4 overflow-hidden rounded-full bg-background p-2 text-text transition-all duration-700 group-hover:w-[120px] hover:w-[120px] "
          >
